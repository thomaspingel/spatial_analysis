These notebooks with require an installation of [ArcGIS Pro](https://www.binghamton.edu/geography/gis/lab_resources.html) and Anaconda with a class environment.
...
~~~
conda create --name gis -c conda-forge python=3.11 spyder jupyter scipy seaborn geopandas scikit-image rasterio statsmodels openpyxl
~~~
