...
~~~
conda create --name gis conda-forge python=3.11 spyder jupyter jupyterlab numpy pandas matplotlib seaborn geopandas scikit-image rasterio statsmodels openpyxl
~~~
